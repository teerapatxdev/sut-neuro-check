...
class CardResult extends HTMLElement {
  ...
  async connectedCallback() {
    ...
    if (resultData.result) {
      let result = '';
      let disease = '';
      if (Number(resultData.result) >= 25) {
        result = `
            <div class="show-img">
                <img class="icon-result" src="../../../assets/images/very-danger.png">
            </div>
            <p class="result-header">อยู่ในระดับรุนแรงมาก</p>`;
      } else if (
        Number(resultData.result) >= 15 &&
        Number(resultData.result) <= 24
      ) {
        result = `
            <div class="show-img">
                <img class="icon-result" src="../../../assets/images/danger.png">
            </div>
            <p class="result-header">อยู่ในระดับรุนแรง</p>`;
      } else if (
        Number(resultData.result) >= 5 &&
        Number(resultData.result) <= 14
      ) {
        result = `
            <div class="show-img">
                <img class="icon-result" src="../../../assets/images/middle.png">
            </div>
            <p class="result-header">อยู่ในระดับน้อย-ปานกลาง</p>`;
      } else {
        result = `
            <div class="show-img">
                <img class="icon-result-good" src="../../../assets/images/good.png">
            </div>
            <p class="result-header-good">อยู่ในระดับน้อยมาก</p>`;
      }
            ...
            <div class="content-center">
                ...
                <div class="content-user">
                    ...
                    <div class="d-row">
                        ...
                        <p class="p-col-2">${resultData.age}<span>ปี</span></p>
                    </div>
                    <div class="d-row">
